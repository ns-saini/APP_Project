...
\section{Quality Attributes}
  ...
  \begin{figure}[h!]
    \centering
    \frame{\includegraphics[scale= 0.3]{resources/github.png}}
  ...
  \section{Programming Style}
    The guidelines provied under PEP 8 was followed during the development of source code. The PyLint linter was used to enforce this. 
    \begin{figure}[h!]
      \centering
      \frame{\includegraphics[scale= 0.3]{resources/pylint.png}}
      \caption{update this}
      \label{fig:linter}
    \end{figure}
