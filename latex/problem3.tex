...
\section{Quality Attributes}
  ...
  \subsection{Generality}
    \begin{flushleft}
      The program has been made more general by avoiding the use of OS specific path(s). E.g. When writing to an output file, relative path name was used.
    \end{flushleft}
