...
\begin{itemize}
  ...
  \item To compute the exponent of a number using iteration.
  \item To compute the factorial of a number using iteration.
...
\begin{itemize}
  ...
  \item The a maximum of 100 attempts will be made to find the roots of the equation after which the function will be declared as non-convergant.  
\end{itemize}
